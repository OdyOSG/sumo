...
#' @param tiab a character vector of terms in the title and abstract to use in the search
#' @export
...
#' @param searchStrategy A completed search strategy generated by combineSearchStrategy
#' @export
